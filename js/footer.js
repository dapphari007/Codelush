        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>580,Pillayar Koil Street,Rajapalayam.</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="">Refer Now</a>
                    <a class="btn btn-link" href="">Internships</a>
                    <a class="btn btn-link" href="">Mentorships</a>
                    <a class="btn btn-link" href="">Promotions</a>
                </div>
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="testimonial.html">Terms & Condition</a>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>
                        Join our newsletter for daily live updates on internship opportunities.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="index.html">Codelush</a>, All Right Reserved.
                </div>
